...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'swdf.benchmark': { 'swdf.benchmark.forecast_error': ('benchmark.html#forecast_error', 'swdf/benchmark.py'),
            ...
            'swdf.losses': { 'swdf.losses.ClassificationLoss': ('losses.html#classificationloss', 'swdf/losses.py'),
                             ...
                             'swdf.losses.LossMetrics._calculate_misclassifications': ( 'losses.html#lossmetrics._calculate_misclassifications',
                                                                                        'swdf/losses.py'),
                             'swdf.losses.LossMetrics._count_misclassifications_by_level': ( 'losses.html#lossmetrics._count_misclassifications_by_level',
                                                                                             'swdf/losses.py'),
                             'swdf.losses.LossMetrics.avg_count_elevated': ('losses.html#lossmetrics.avg_count_elevated', 'swdf/losses.py'),
                             'swdf.losses.LossMetrics.avg_count_high': ('losses.html#lossmetrics.avg_count_high', 'swdf/losses.py'),
                             'swdf.losses.LossMetrics.avg_count_low': ('losses.html#lossmetrics.avg_count_low', 'swdf/losses.py'),
                             'swdf.losses.LossMetrics.avg_count_moderate': ('losses.html#lossmetrics.avg_count_moderate', 'swdf/losses.py'),
