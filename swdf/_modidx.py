  ...
  'syms': { 'swdf.benchmark': { 'swdf.benchmark.forecast_error': ('benchmark.html#forecast_error', 'swdf/benchmark.py'),
            ...
            'swdf.metrics': { 'swdf.metrics.AUPRCMetric': ('metrics.html#auprcmetric', 'swdf/metrics.py'),
                              ...
                              'swdf.metrics.OutlierDetectionMetrics.get_metrics': ( 'metrics.html#outlierdetectionmetrics.get_metrics',
                                                                                    'swdf/metrics.py'),
                              'swdf.metrics.R2Score': ('metrics.html#r2score', 'swdf/metrics.py'),
                              'swdf.metrics.R2Score.R2': ('metrics.html#r2score.r2', 'swdf/metrics.py'),
                              'swdf.metrics.R2Score.__init__': ('metrics.html#r2score.__init__', 'swdf/metrics.py'),
                              'swdf.metrics.R2Score.get_metrics': ('metrics.html#r2score.get_metrics', 'swdf/metrics.py'),
