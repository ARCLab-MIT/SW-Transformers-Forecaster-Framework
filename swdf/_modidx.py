...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'swdf.benchmark': { 'swdf.benchmark.forecast_error': ('benchmark.html#forecast_error', 'swdf/benchmark.py'),
            ...
            'swdf.losses': { 'swdf.losses.Loss': ('losses.html#loss', 'swdf/losses.py'),
                             ...
                             'swdf.losses.LossMetrics.mse_loss_elevated': ('losses.html#lossmetrics.mse_loss_elevated', 'swdf/losses.py'),
                             'swdf.losses.LossMetrics.mse_loss_high': ('losses.html#lossmetrics.mse_loss_high', 'swdf/losses.py'),
                             'swdf.losses.LossMetrics.mse_loss_low': ('losses.html#lossmetrics.mse_loss_low', 'swdf/losses.py'),
                             'swdf.losses.LossMetrics.mse_loss_moderate': ('losses.html#lossmetrics.mse_loss_moderate', 'swdf/losses.py'),
