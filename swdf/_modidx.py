...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'swdf.benchmark': { 'swdf.benchmark.forecast_error': ('benchmark.html#forecast_error', 'swdf/benchmark.py'),
            ...
            'swdf.metrics': { 'swdf.metrics.AUPRCMetric': ('metrics.html#auprcmetric', 'swdf/metrics.py'),
                              ...
                              'swdf.metrics.ValidationMetricsFactory': ('metrics.html#validationmetricsfactory', 'swdf/metrics.py'),
                              'swdf.metrics.ValidationMetricsFactory.__init__': ( 'metrics.html#validationmetricsfactory.__init__',
                                                                                  'swdf/metrics.py'),
                              'swdf.metrics.ValidationMetricsFactory._validate_upload': ( 'metrics.html#validationmetricsfactory._validate_upload',
                                                                                          'swdf/metrics.py'),
                              'swdf.metrics.ValidationMetricsFactory.get_metrics': ( 'metrics.html#validationmetricsfactory.get_metrics',
                                                                                     'swdf/metrics.py'),
                              'swdf.metrics.ValidationMetricsFactory.get_objective_values': ( 'metrics.html#validationmetricsfactory.get_objective_values',
                                                                                              'swdf/metrics.py'),
                              'swdf.metrics.ValidationMetricsFactory.get_study_directions': ( 'metrics.html#validationmetricsfactory.get_study_directions',
                                                                                              'swdf/metrics.py'),
                              'swdf.metrics.ValidationMetricsFactory.list': ( 'metrics.html#validationmetricsfactory.list',
                                                                              'swdf/metrics.py'),
                              'swdf.metrics.ValidationMetricsFactory.upload': ( 'metrics.html#validationmetricsfactory.upload',
                                                                                'swdf/metrics.py')},
