...
# %% auto 0
__all__ = ['config', 'plot_forecast_2', 'plot_solar_algorithm_performance', 'bold_best', 'convert_uuids_to_indices',
           'get_classified_columns', 'clean_f10_values', 'get_F10_historical_distribution', 'euclidean_distance_dict',
